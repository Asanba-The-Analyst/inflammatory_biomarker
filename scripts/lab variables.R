...
# To select only test performance variables
df_performed <- df %>% select(all_of(test_performed_vars))

# To select only lab result variables
df_results <- df %>% select(all_of(lab_result_vars))